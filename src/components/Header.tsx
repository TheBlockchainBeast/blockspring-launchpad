...
export function Header() {
  ...
  return (
    <header className="dark:bg-[#0A0A0A] bg-white shadow border-b dark:border-[#1C1C1C] border-gray-200">
      <div className="container mx-auto px-4 py-6 flex justify-between items-center">
        ...
        <nav className="hidden md:flex items-center gap-10">
          ...
          <button className="relative group">
            ...
            <div className="relative px-6 py-4 dark:bg-[#0A0A0A] bg-white rounded-lg leading-none dark:text-white text-gray-900">
              Get Started
            </div>
          </button>
        </nav>
